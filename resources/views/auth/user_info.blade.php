           ...
           @foreach ($posts as $post)
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body" style="height:  50px; margin-bottom: 50px;">
                  <p class="card-text" style="text-align: right;direction:  rtl;">{{\Illuminate\Support\Str::limit($post['body'], 30)}}</p>
                  <br>
                </div>
