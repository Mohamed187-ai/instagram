    ...
    <div class="row">
          ...
          <div class="media text-muted pt-3">
            ...
            <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray" >
              <div class="d-flex justify-content-between align-items-center w-100">
                ...
                <!-- رفض الطلب -->
                <form action="{{action('FollowController@destroy', $request['id'])}}" method="POST">
                    @csrf
                    <input type="submit" name="" class="btn btn-outline-warning" value="رفض الطلب" style="margin-right: 40%;">
                    <input type="hidden" name="_method" value="DELETE">
                    <input type="hidden" name="redirect_to" value="user/followers" >
                </form>

                <!-- قبول الطلب -->
                <form action="{{action('FollowController@update', $request['id'])}}"  method="POST">
                    @csrf
      ...
      <div class="col-md-6">
        <div class="my-3 p-3 bg-white rounded box-shadow" style="direction:  rtl;text-align:  right;">
            ...
            <!-- User define -->
            @php
                $user = $follower->from_user_id == auth()->user()->id ? $follower->to_user : $follower->from_user;
            @endphp
            <div class="media text-muted pt-3">
            ...
            <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                ...
                <!-- حذف الصداقة -->
                <form action="{{action('FollowController@destroy', $follower['id'])}}" method="POST">
                    @csrf
